            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="user/insert.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Username</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="" class="form-control p-0 border-0" name="username">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Password</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="password" value="" class="form-control p-0 border-0" name="password">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Choose Avatar</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file"
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="col-sm-12">Choose Permission</label>
                                        <div class="col-sm-12 border-bottom">
                                            <select name="permission" class="form-control p-0 border-0">
