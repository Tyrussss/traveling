            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Information Tour</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="tour/update.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Id Tour</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['idtour']; ?>" class="form-control p-0 border-0" name="idtour" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Name Tour</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['name']; ?>" class="form-control p-0 border-0" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Days</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['time']; ?>"
                                                class="form-control p-0 border-0" name="time">
                                        </div>
                                    </div>                                    
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Place</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['place']; ?>"
                                                class="form-control p-0 border-0" name="place">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Change Image</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['author']; ?>"
                                                class="form-control p-0 border-0" name="author" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
