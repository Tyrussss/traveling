                    ...
                    <ul class="navbar-nav ml-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="../images/<?php echo $_SESSION['admin']['avatar']; ?>" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium"><?php echo $_SESSION['admin']['username']; ?></span></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
...
<!--                         <li class="sidebar-item">
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <a href="../logout.php" class="btn btn-block btn-danger text-white" target="_blank">
                                LogOut
                            </a>
                        </li>
                    </ul>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-uppercase font-medium font-14">Tour Detail</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="update_detail.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Detail</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" value="<?php echo $data['idtour']; ?>" class="form-control p-0 border-0" name="idtour" hidden>
                                            <textarea class="form-control p-0 border-0" name="detail" id="detail"><?php echo $data['detail']; ?></textarea>
                                        </div>
                                    </div>
